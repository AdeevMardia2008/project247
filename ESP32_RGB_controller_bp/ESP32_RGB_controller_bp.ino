...
void setup(){
  ...
  server.on(' /red ' , color_generator)
  server.on(' /green ' , color_generator)
  server.on(' /blue ' , color_generator)
  server.on(' /yellow ' , color_generator)
  server.on(' /cyan ' , color_generator)
  server.on(' /magenta ' , color_generator)
  server.on(' /orange ' , color_generator)
